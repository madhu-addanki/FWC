...
\def\myauthor{MADHU LATHA ADDANKI (FWC22129)}
\def\contact{madhulathaaddanki@gmail.com}
...
\usepackage{multirow}
\usepackage{graphicx}
\graphicspath{{/sdcard/Download/latex/CS282021/trunk/figures}}
